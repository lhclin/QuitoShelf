...
/* [Making] */
Making="Plate Stoppers"; // ["Plate Stoppers","Side Clip Back Slim","Side Clip Back Standard","Side Clips Air Vent","Mounting Screw 25mm","Mounting Screw 40mm"]
...
} else if (Making=="Side Clip Back Standard") {
